...
# Order clue.erastin_6h_5um.sig_24h based on erastin 6h and upreg/downreg status
clue.erastin_6h_5um.sig_l1000$upregulated <- sig_l1000$upregulated
clue.erastin_6h_5um.sig_l1000$sums <- 0
for(x in 1:length(clue.erastin_6h_5um.sig_l1000$NCIH508)){
  clue.erastin_6h_5um.sig_l1000$sums[x] <-table(clue.erastin_6h_5um.sig_l1000[x,] >0)[2]
}
clue.erastin_6h_5um.sig_l1000 %<>% arrange(upregulated, -sums)
clue.erastin_6h_5um.sig_l1000 %<>% select(-sums, -upregulated)

# order other datasets based on clue.erastin_6h_5um.sig_24h
rna.sig_l1000 <- rna.sig_l1000[order(match(rownames(rna.sig_l1000),rownames(clue.erastin_6h_5um.sig_l1000))),]
clue.erastin_24h_10um.sig_l1000 <- clue.erastin_24h_10um.sig_l1000[order(match(rownames(clue.erastin_24h_10um.sig_l1000),rownames(clue.erastin_6h_5um.sig_l1000))),]
clue.erastin_24h_5um.sig_l1000 <- clue.erastin_24h_5um.sig_l1000[order(match(rownames(clue.erastin_24h_5um.sig_l1000),rownames(clue.erastin_6h_5um.sig_l1000))),]
...
temp <- clue.erastin_24h_5um.sig_l1000
## order by 24h row sums
temp %<>% mutate(sums = rowSums(abs(temp))) 
## label as upreg/downreg
temp$upregulated <- sig_l1000$upregulated
temp %<>%
  arrange(upregulated, -sums) %>%
  select(-sums, -upregulated)

# order other datasets based on clue.erastin_6h_5um.sig_24h
rna.sig_l1000 <- rna.sig_l1000[order(match(rownames(rna.sig_l1000),rownames(temp))),]
clue.erastin_6h_5um.sig_l1000 <- clue.erastin_6h_5um.sig_l1000[order(match(rownames(clue.erastin_6h_5um.sig_l1000),rownames(temp))),]
clue.erastin_24h_10um.sig_l1000 <- clue.erastin_24h_10um.sig_l1000[order(match(rownames(clue.erastin_24h_10um.sig_l1000),rownames(temp))),]
