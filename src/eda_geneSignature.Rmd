...
# filter clue dataset for genes of interest
clue.erastin_6h_5um.kras.sub <- clue.erastin_6h_5um.kras %>%
  dplyr::filter(rownames(.) %in% rownames()) 
...
elim <- c('T3M10_5um_6h_5um_6h', 'CORL23_5um_6h_5um_6h', 'SNU1040_5um_6h_5um_6h', 'CL34_5um_6h_5um_6h', 'NCIH1694_5um_6h_5um_6h')
