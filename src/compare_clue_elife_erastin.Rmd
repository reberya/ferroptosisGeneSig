...
clean_clue <- function(clue, dose = '10 µM', time = '6 h'){
...
clue.art <- fread('/mctp/share/users/rebernrj/projects/ferroptosisGeneSig/data/clue/artesunate/clue_v1.3_artesunate_1.gct', skip = 2, data.table = F)

clue.art <- clean_clue(clue.art)
