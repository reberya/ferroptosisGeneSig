...
According to the elife 2014 paper (DOI: 10.7554/eLife.02523): "From two independent biological replicates, we obtained an average of ∼30.5 million unique mapped reads and 11,867 unique transcripts".
...
# Remove duplicate genes based on expression in control
counts %<>% dplyr::arrange(-dmso_1)
counts = counts[!duplicated(counts$gene),]

# write to file
write.table(counts,'/mctp/share/users/rebernrj/projects/ferroptosisGeneSig/int/elife2014_erastin/rna_seq/elife_counts_from_fpkm.txt',
